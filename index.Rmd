...
renderPlot({
  ...
  geom_polygon(aes(x=long,y=lat, group=group, fill=number, text=province), color='black')+
...
# Interactive National ECE Programs
...
```{r echo=FALSE}
 selectInput("province", label = h3("Select Province"), 
    choices = unique(year$province),
    selected = "DKI Jakarta")
sliderInput('year', label =h3('Select Year'), min=2017, max=2020,
...
### Number of Student enrolled, Teacher, & ECE center by Province from 2017-2020
